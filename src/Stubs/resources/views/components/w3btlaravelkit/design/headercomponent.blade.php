{{-- @include('components::components.design.headercomponent') --}}
<div class="fixed z-50 w-full shadow-md bg-neutral text-neutral-content">
    <nav class="flex justify-between items-center py-1 lg:px-8">
        ...
        <div class="flex items-center space-x-5 lg:ml-[-1rem] xl:ml-[-2rem]">
            <img src="{{ asset('assets/img/Logo T-1.png') }}" alt="Logo"
                class="ml-3 w-8 h-8 bg-white rounded-full sm:w-10 sm:h-10">
            <h3 class="hidden text-lg font-semibold sm:block">W3B-IntelliCredit</h3>
        </div>

        <!-- Opciones de usuario, tema, ajustes y logo Águila Pemex -->
        <div class="flex items-center space-x-4">
            ...
            <div class="relative dropdown dropdown-end">
                ...
                <ul tabindex="0"
                    ...
                    <livewire:pages.auth.admin.admin-logout />
                </ul>
            </div>
            <!-- Logo Águila Pemex -->
